...
public class GetEmployeeTest extends PerformanceTest {
	...
	public GetEmployeeTest(String testName, int minSalary, int MaxSalary, int count, GeneratorMode mode, int nRuns) {
	...
	protected void runTest() {
		for (Employee empl : randomEmpl) {
			employees.getEmployee(empl.getId());
		}
	}
